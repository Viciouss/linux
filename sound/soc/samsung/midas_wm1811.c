...
SND_SOC_DAILINK_DEFS(aif1,
	...
	DAILINK_COMP_ARRAY(COMP_PLATFORM(SAMSUNG_I2S_DAI)));

SND_SOC_DAILINK_DEFS(aif2,
	DAILINK_COMP_ARRAY(COMP_CPU(SAMSUNG_I2S_DAI)),
	DAILINK_COMP_ARRAY(COMP_CODEC("wm8994-codec", "wm8994-aif2")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM(SAMSUNG_I2S_DAI)));

SND_SOC_DAILINK_DEFS(aif3,
	DAILINK_COMP_ARRAY(COMP_CPU(SAMSUNG_I2S_DAI)),
	DAILINK_COMP_ARRAY(COMP_CODEC("wm8994-codec", "wm8994-aif3")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM(SAMSUNG_I2S_DAI)));
...
static int midas_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < card->num_links; i++) {
		...
		card->dai_link[i].codecs->name = NULL;
