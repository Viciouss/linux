...
static int p4note_start_fll1(struct snd_soc_pcm_runtime *rtd, unsigned int new_rate)
{
	...
	ret = snd_soc_dai_set_pll(rtd->codec_dai, WM8994_FLL1,
	...
	ret = snd_soc_dai_set_sysclk(rtd->codec_dai, WM8994_SYSCLK_FLL1,
...
MODULE_DESCRIPTION("ASoC support for p4note");
